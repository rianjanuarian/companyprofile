	...
	<div class="container" id="container">
		<div class="form-container sign-up-container">
			...
			<form action="<?= base_url('Auth/proses_register') ?>" method="post">
				...
				<input type="text" name="username" placeholder="Username" value="<?= set_value('username1') ?>" />
				<?= form_error('username', '<small class="text-danger pl-2">', '</small>'); ?>
				<input type="text" name="nama" placeholder="Name" value="<?= set_value('name') ?>" />
			...
			<div class="container" id="container">
				<div class="form-container sign-up-container">
					...
					<form action="<?= base_url('Auth/proses_register') ?>" method="post">
						...
						<input type="text" name="nama" placeholder="Name" value="<?= set_value('nama') ?>" />
						<?= form_error('name', '<small class="text-danger pl-2">', '</small>'); ?>
						<input type="email" name="email" placeholder="Email" value="<?= set_value('email') ?>" />
						<?= form_error('email', '<small class="text-danger pl-2">', '</small>'); ?>
						<input type="text" name="nomor_hp" placeholder="No Hp" value="<?= set_value('nomor_hp') ?>" />
